...
description: >
  ...
  Google Antigravity (CLI), Gemini CLI, OpenAI Codex, OpenCode）を読み取り、技術理解度・プロンプティングパターン・AI依存度を推定してレポートを生成する。
...
このスクリプトは Claude Code, GitHub Copilot Chat, Cursor, Cline, Roo Code, Windsurf, Google Antigravity (CLI), Gemini CLI, OpenAI Codex, OpenCode の
